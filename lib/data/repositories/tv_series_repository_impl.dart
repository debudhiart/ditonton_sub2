...
class TVSeriesRepositoryImpl implements TVSeriesRepository {
  ...
  Future<Either<Failure, String>> saveTVSeriesFromWatchlist(
    ...
    try {
      final result = await localDataSource
          .addTVSeriesWatchlist(TVSeriesTable.fromEntity(tvSeries));
      return Right(result);
  ...
  Future<Either<Failure, String>> deleteTVSeriesFromWatchlist(
    ...
    try {
      final result = await localDataSource
          .deleteTVSeriesWatchlist(TVSeriesTable.fromEntity(tvSeries));
      return Right(result);
    } on DatabaseException catch (e) {
      return Left(DatabaseFailure(e.message));
    }
  ...
  @override
  Future<Either<Failure, List<TVSeries>>> getDataTVSeriesWatchlist() async {
