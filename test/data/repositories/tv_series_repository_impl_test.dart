...
void main() {
  ...
  group('save watchlist', () {
    test('should return success message when saving successful', () async {
      // arrange
      when(mockLocalDataSource.addTVSeriesWatchlist(testTVSeriesTable))
          .thenAnswer((_) async => 'Added to Watchlist');
      // act
      final result = await repository
          .saveTVSeriesFromWatchlist(testTVSeriesDetailResponseEntity);
      // assert
  ...
  group('remove watchlist', () {
    test('should return success message when remove successful', () async {
      // arrange
      when(mockLocalDataSource.deleteTVSeriesWatchlist(testTVSeriesTable))
          .thenAnswer((_) async => 'Removed from watchlist');
      // act
      final result = await repository
          .deleteTVSeriesFromWatchlist(testTVSeriesDetailResponseEntity);
      // assert
  ...
  group('get watchlist TV Series', () {
    test('should return list of TV Series', () async {
      ...
      // act
      final result = await repository.getDataTVSeriesWatchlist();
      // assert
      final resultList = result.getOrElse(() => []);
